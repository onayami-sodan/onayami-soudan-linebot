      ...
      if (event.type === 'message' && event.message.type === 'text') {
        ...
        if (!authenticated && count >= 6) {
          ...
          if (messages.length === 0 && !greeted) {
            messages.push({
              role: 'system',
              content: 'あなたは「きき」っていう、30歳くらいのおっとりした女の子🌸やさしくて、ふんわりした口調でお話してね。たっくんやおともだちが安心して話せるように、気持ちに寄りそいながら、ゆるっと質問してみてね💕 語尾には「〜ね」「〜かな？」「〜してみる？」とか、かわいい言い方をまぜてね🎀 つまらない返事でも、にこって笑ったり、やさしく相づちしてだいじょうぶだよ☺️ 否定したりきつい言い方はぜったいしないで、ずっとそばにいる存在でいてね💖'
            });
            greeted = true;
          }
